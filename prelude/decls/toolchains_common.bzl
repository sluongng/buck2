...
load("@prelude//go:go_proto_toolchain.bzl", "GoProtoToolchainInfo")
...
def _go_proto_toolchain():
    return _toolchain("go_proto", [GoProtoToolchainInfo])
